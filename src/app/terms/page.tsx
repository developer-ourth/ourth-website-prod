  ...
  return (
    <main>
      ...
      <section className="mx-auto max-w-4xl px-6 pt-36 pb-20">
        <h1 className="mb-8 text-4xl font-bold text-[#0D3A27]">Terms of Service</h1>
        ...
        <div className="space-y-6 text-lg text-[#2C1F13]">
          ...
          <div>
            <h2 className="mb-3 text-2xl font-semibold text-[#0D3A27]">1. Acceptance of Terms</h2>
            <p>
          ...
          <div>
            <h2 className="mb-3 text-2xl font-semibold text-[#0D3A27]">2. Use License</h2>
          ...
          <div>
            <h2 className="mb-3 text-2xl font-semibold text-[#0D3A27]">3. Disclaimer</h2>
            <p>
          ...
          <div>
            <h2 className="mb-3 text-2xl font-semibold text-[#0D3A27]">4. Limitations</h2>
            <p>
          ...
          <div>
            <h2 className="mb-3 text-2xl font-semibold text-[#0D3A27]">5. Accuracy of Materials</h2>
            <p>
          ...
          <div>
            <h2 className="mb-3 text-2xl font-semibold text-[#0D3A27]">6. Links</h2>
            <p>
          ...
          <div>
            <h2 className="mb-3 text-2xl font-semibold text-[#0D3A27]">7. Modifications</h2>
            <p>
          ...
          <div>
            <h2 className="mb-3 text-2xl font-semibold text-[#0D3A27]">8. Governing Law</h2>
            <p>
          ...
          <div>
            <h2 className="mb-3 text-2xl font-semibold text-[#0D3A27]">9. User Responsibilities</h2>
          ...
          <div>
            <h2 className="mb-3 text-2xl font-semibold text-[#0D3A27]">10. Product Information and Pricing</h2>
            <p className="mb-3">
          ...
          <div>
            <h2 className="mb-3 text-2xl font-semibold text-[#0D3A27]">11. Payment and Order Acceptance</h2>
            <p>
          ...
          <div>
            <h2 className="mb-3 text-2xl font-semibold text-[#0D3A27]">12. Contact Information</h2>
            <p>
