      ...
      <div className="mx-auto max-w-[1200px] px-6 sm:px-12 relative z-10 flex flex-col md:flex-row items-center gap-12 lg:gap-20">
        ...
        <div className="w-full md:w-1/2 flex flex-col items-center md:items-start text-center md:text-left space-y-6 sm:space-y-8">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 pt-4 w-full sm:w-auto">
            ...
            <NextLink href={`/products/${bestSeller.slug || bestSeller.sku || bestSeller.id}`} className="w-full sm:w-auto text-center px-10 py-4 bg-white text-[#0D3A27] border-2 border-[#0D3A27] rounded-full font-bold text-[15px] sm:text-[17px] hover:bg-[#EBF2E4] transition-colors shadow-md hover:shadow-lg active:scale-95">
              View Details
            </NextLink>
          </div>
        </div>
