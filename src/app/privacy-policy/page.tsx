  ...
  return (
    <main>
      ...
      <section className="mx-auto max-w-4xl px-6 pt-36 pb-20">
        <h1 className="mb-8 text-4xl font-bold text-[#0D3A27]">Privacy Policy</h1>
        ...
        <div className="space-y-6 text-lg text-[#2C1F13]">
          ...
          <div>
            <h2 className="mb-3 text-2xl font-semibold text-[#0D3A27]">Introduction</h2>
            <p>
          ...
          <div>
            <h2 className="mb-3 text-2xl font-semibold text-[#0D3A27]">1. Information We Collect</h2>
          ...
          <div>
            <h2 className="mb-3 text-2xl font-semibold text-[#0D3A27]">2. How We Use Your Information</h2>
          ...
          <div>
            <h2 className="mb-3 text-2xl font-semibold text-[#0D3A27]">3. Information Sharing and Disclosure</h2>
          ...
          <div>
            <h2 className="mb-3 text-2xl font-semibold text-[#0D3A27]">4. Data Security</h2>
            <p>
          ...
          <div>
            <h2 className="mb-3 text-2xl font-semibold text-[#0D3A27]">5. Your Rights and Preferences</h2>
          ...
          <div>
            <h2 className="mb-3 text-2xl font-semibold text-[#0D3A27]">6. Cookies and Tracking Technologies</h2>
            <p>
          ...
          <div>
            <h2 className="mb-3 text-2xl font-semibold text-[#0D3A27]">7. Third-Party Links</h2>
            <p>
          ...
          <div>
            <h2 className="mb-3 text-2xl font-semibold text-[#0D3A27]">8. Children's Privacy</h2>
            <p>
          ...
          <div>
            <h2 className="mb-3 text-2xl font-semibold text-[#0D3A27]">9. Policy Changes</h2>
            <p>
          ...
          <div>
            <h2 className="mb-3 text-2xl font-semibold text-[#0D3A27]">10. Contact Us</h2>
            <p>
